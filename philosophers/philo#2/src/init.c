...
/*   Updated: 2024/03/05 10:34:46 by mgallais         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// program. It also initializes the forks and the philos.
static void	init_data(t_data *data, int number_of_philosophers, char **argv)
{
	...
	if (argv[5])
		data->nb_meals = ft_atoi(data, argv[5]);
	else
		data->nb_meals = -1;
...
void	init(t_data *data, int argc, char **argv)
{
	...
	if (argc == 5 || argc == 6)
	{
		number_of_philosophers = ft_atoi(data, argv[1]);
